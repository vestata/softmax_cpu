...
plot \
  ...
  'data/time_safe_softmax_fastexp.csv' every ::1 using 1:2 with linespoints title 'Scalar fast exp', \
  ...
  'data/time_softmax_online_scalar.csv' every ::1 using 1:2 with linespoints title 'Online_scalar'
